...
class Player:
    ...
    def update(self):
        ...
        self.grid_pos[1] = (
            self.pix_pos[1]-TOP_BOTTOM_BUFFER+self.app.cell_height//2)//self.app.cell_height+1
    ...
    def draw(self):
        ...
        #pygame.draw.rect(
        #   self.app.screen, RED, (self.grid_pos[0]*self.app.cell_width+TOP_BOTTOM_BUFFER//2,
