...
#-----------------------------HELPER FUNCTIONS-----------------------------------#    
    ...
    def draw_coins(self):
        for coin in self.coins:
            pygame.draw.circle(
                self.screen, WHITE, (int(coin.x*self.cell_width)+self.cell_width//2+TOP_BOTTOM_BUFFER//2, 
...
#-----------------------------START FUNCTIONS------------------------------------#
    ...
    def start_draw(self):
        ...
        self.draw_text('WHERE DO SPACE MEN GO TO DRINK', self.screen, [WIDTH//2, HEIGHT//2], START_TEXT_SIZE, (170, 132, 58), START_FONT, centered=True)
        self.draw_text('1 PLAYER ONLY', self.screen, [WIDTH//2, HEIGHT//2+37], START_TEXT_SIZE, (59, 169, 196), START_FONT, centered=True)
...
#-----------------------------PLAYING FUNCTIONS-----------------------------------#
    ...
    def playing_draw(self):
        ...
        self.draw_coins()
        self.draw_text('CURRENT SCORE: {}'.format(self.player.current_score), self.screen, (30, 1), 18, WHITE, START_FONT)
